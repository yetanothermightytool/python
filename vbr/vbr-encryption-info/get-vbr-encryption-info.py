...
def encryption_info(api_url, token, html=False):
...
def main():
    ...
    encryption_parser.add_argument("--html", action="store_true", help="Export report as HTML")
    ...
    try:
        if args.command == "encryption-info":
            encryption_info(api_url, token, html=args.html)
    finally:
